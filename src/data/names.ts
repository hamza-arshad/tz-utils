...
export const notWorkingInMoment = [
  'US/Pacific-New',
] as const

export const notWorkingInDateFnsNoFallback = [
  'Etc/GMT+12',
]
...
export const notWorkingInDateFns = {
  ...
  'Etc/GMT+4': 'America/Barbados',
  'Etc/GMT+5': 'America/Jamaica',
  ...
  'Etc/GMT-11': 'Pacific/Efate',
  'Etc/GMT-12': 'Pacific/Nauru',
